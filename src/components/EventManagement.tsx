      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 bg-white p-6 rounded-2xl border border-slate-200 shadow-xs">
        ...
        {activeRole === 'admin' && (
          <button
            ...
            className="inline-flex items-center justify-center gap-2 px-5 py-2.5 rounded-xl bg-blue-600 hover:bg-blue-700 text-white font-semibold text-xs sm:text-sm transition-all shadow-md shadow-blue-500/20"
          >
            ...
            {['all', 'active', 'draft', 'completed'].map((st) => (
              <button
                ...
                className={`px-3 py-1.5 rounded-lg font-medium transition-colors capitalize ${
                  filterStatus === st ? 'bg-white text-blue-700 shadow-xs font-semibold' : 'text-slate-600 hover:text-slate-900'
                }`}
              >
